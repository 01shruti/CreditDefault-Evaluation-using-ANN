...
m <- model.matrix(~Income + LoanBalance + Age + InterestType + MortgageType + InterestIncome + MortgageYears + AnnualPayment + CreditRating + LoanToValue + Default, data = dataset)
