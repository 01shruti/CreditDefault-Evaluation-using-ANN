...
gwplot(nn,selected.covariate="funded_amnt",min=-2.5, max=5)
gwplot(nn,selected.covariate="funded_amnt_inv",min=-2.5, max=5)
gwplot(nn,selected.covariate="term",min=-2.5, max=5)
gwplot(nn,selected.covariate="int_rate", min=-2.5, max=5)
gwplot(nn,selected.covariate="installment", min=-2.5, max=5)
gwplot(nn,selected.covariate="emp_length", min=-2.5, max=5)
gwplot(nn,selected.covariate="annual_inc", min=-2.5, max=5)
gwplot(nn,selected.covariate="application_type", min=-2.5, max=5)
